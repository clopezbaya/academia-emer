...
Route::middleware(['auth'])->group(function () {
    ...
    // my bootcamp routes
    Route::controller(MyBootcampsController::class)->middleware('feature:bootcamps')->group(function () {
    ...
    Route::controller(BootcampPurchaseController::class)->middleware('feature:bootcamps')->group(function () {
    ...
    // my team packages
    Route::controller(MyTeamPackageController::class)->middleware('feature:teams')->group(function () {
