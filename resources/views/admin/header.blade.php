    ...
    <div class="header-content-right d-flex align-items-center justify-content-end">
        ...
        <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Help Center') }}">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <div class="p-2">
                    <h5 class="title text-14px">{{ get_phrase('Soporte') }}</h6>
                </div>
                <li>
                    <a href="https://codeingdigital.com" target="_blank" class="dropdown-item">
                        <i class="fi-rr-document-signed"></i>
                        <span>{{ get_phrase('Documentation') }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="https://codeingdigital.com" target="_blank" class="dropdown-item">
                        ...
                        <span>{{ get_phrase('video tutorial') }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="https://codeingdigital.com" target="_blank" class="select-text text-capitalize">
                        <i class="fi-rr-add"></i>
                        <span>{{ get_phrase('Request a new feature') }}</span>
                    </a>
                </li>
                <li>
                    <a href="https://codeingdigital.com" target="_blank" class="text-premium select-text text-capitalize d-flex align-items-center">
