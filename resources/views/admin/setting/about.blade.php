                                            ...
                                            <div class="chart-widget-list">
                                                ...
                                                <p class="border-bottom mb-2 pb-2 text-13px d-flex align-items-center">
                                                    ...
                                                    <span class="ms-auto float-end">
                                                        <a href="https://codeingdigital.com" target="_blank">
                                                ...
                                                <p class="border-bottom mb-2 pb-2 text-13px d-flex align-items-center">
                                                    ...
                                                    @else
                                                        <span class="ms-auto float-end badge bg-success mt-1 text-capitalize">{{ $application_details['product_license'] }}</span>
                                                ...
                                                <p class="border-bottom mb-2 pb-2 text-13px d-flex align-items-center">
                                                    ...
                                                    <span class="ms-auto float-end">
                                                        @if (strtolower($application_details['purchase_code_status']) == 'expired')
                                                            ...
                                                            <a href="https://codeingdigital.com" target="_blank" class="btn btn-success float-end me-2 py-0 text-13px">{{ get_phrase('Renew support') }}</a>
                                                ...
                                                <p class="border-bottom mb-2 pb-2 text-13px d-flex align-items-center">
                                                    ...
                                                    <span class="ms-auto float-end"><a class="about-sc-one" href="http://codeingdigital.com" target="_blank"> <i class="bi bi-telegram"></i>
