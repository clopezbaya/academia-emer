...
<!-----------  Header Area Start  ------------->
<header class="header-area bg-neutral">
    <div class="container">
        <div class="row flex-md-nowrap">
            <div class="col-auto">
                <div class="logo-image">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('images/PARA ONLINE_Mesa de trabajo 1.svg') }}" alt="Academia Emer Logo" class="object-fit-cover rounded header-dark-logo d-block">
                        <img src="{{ asset('images/PARA ONLINE_Mesa de trabajo 1 copia.svg') }}" alt="Academia Emer Light Logo" class="object-fit-cover rounded header-light-logo d-none">
                    </a>
                </div>
            </div>
            <div class="col-auto">
                <div class="header-menu d-flex justify-content-end me-lg-auto ms-lg-0 ms-auto mt-2 pt-1">
                    <div class="nav-menu w-100">
                        <ul class="primary-menu main-menu-ul d-flex align-items-center w-100">
                            <li><a href="{{ route('home') }}" class="text-secondary hover:text-primary @if ($current_route == 'home') text-primary active @endif">{{ get_phrase('Home') }}</a></li>
                            ...
                            <li class="have-mega-menu"><a class="menu-parent-a text-secondary hover:text-primary @if ($current_route == 'courses') text-primary active @endif" href="{{ route('courses') }}">{{ get_phrase('Courses') }}</a>
                                <ul class="mega-dropdown-menu mega main-mega-menu">
                                    <div class="mega-menu-items">
                                        <ul class="mega_list">
                            ...
                            <li class="pe-2 ps-5"><a href="{{ route('bootcamps') }}" class="text-secondary hover:text-primary @if ($current_route == 'bootcamps' || $current_route == 'bootcamp.details') text-primary active @endif">{{ get_phrase('Bootcamp') }}</a></li>
                            ...
                            <li><a href="{{ route('tutor_list') }}" class="text-secondary hover:text-primary @if ($current_route == 'tutor_list') text-primary active @endif">{{ get_phrase('Find A Tutor') }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-sm-5 col-md-3 col-xl-4 ms-lg-0 col-auto ms-auto">
                <form action="{{ route('courses') }}" method="get" class="Esearch_entry d-none d-sm-inline-block w-100 ms-4 mt-2">
                    <input type="text" name="search" class="form-control border-secondary focus:border-primary focus:ring-1 focus:ring-primary" placeholder="{{ get_phrase('Search...') }}" @if (request()->has('search')) value="{{ request()->input('search') }}" @endif>
                                                <button type="submit" class="text-secondary hover:text-primary"><i class="fa-solid fa-magnifying-glass"></i></button>
                                            </form>
                                            <div class="floating-searchbar d-inline-block d-sm-none @auth loged-in @endauth">                    <button type="button" class="mt-1 py-3" onclick="this.parentElement.querySelector('form').classList.toggle('show')"><i class="fa-solid fa-magnifying-glass"></i></button>
            ...
            <div class="ms-lg-auto col-auto">
                <div class="primary-end d-flex align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @isset(auth()->user()->id)
                            <a href="{{ route('cart') }}" class="me-2 me-md-4 position-relative text-secondary hover:text-primary" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Cart') }}" data-bs-placement="bottom">
                                @php
                            ...
                            <a href="{{ route('wishlist') }}" class="me-2 position-relative d-none d-lg-inline-block text-secondary hover:text-primary" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Wishlist') }}" data-bs-placement="bottom">
                                @php
                    ...
                    @if (isset(auth()->user()->id))
                        <div class="Userprofile me-0 me-md-2 ms-2 ms-md-3 d-none d-lg-inline-block">
                            ...
                            <ul class="dropdown-menu dropmenu-end bg-neutral text-secondary" data-popper-placement="bottom-start">
                                <li class="figure_user d-flex">
                                    <img src="{{ get_image(Auth()->user()->photo) }}" alt="user-img">
                                    <div class="figure_text text-secondary">
                                ...
                                @if (in_array(auth()->user()->role, ['admin', 'instructor']))
                                    <li>
                                        <a class="dropdown-item text-secondary hover:text-primary" href="{{ route(auth()->user()->role . '.dashboard') }}">
                                ...
                                @if (Auth()->user()->role != 'admin')
                                    <li>
                                        <a class="dropdown-item text-secondary hover:text-primary" href="{{ route('my.courses') }}">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li>
                                        <a class="dropdown-item text-secondary hover:text-primary" href="{{ route('my.profile') }}">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li>
                                        <a class="dropdown-item text-secondary hover:text-primary" href="{{ route('my.bootcamps') }}" id="bootcamp-icon">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-secondary hover:text-primary" href="{{ route('wishlist') }}">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li>
                                        <a class="dropdown-item text-secondary hover:text-primary" href="{{ route('message') }}">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li>
                                        <a class="dropdown-item text-secondary hover:text-primary" href="{{ route('purchase.history') }}">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <li>
                                    <a class="dropdown-item mb-0 text-secondary hover:text-primary" href="{{ route('logout') }}">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="d-none d-lg-inline-block eBtn btn gradient mb-1 bg-primary text-white hover:bg-primary-light active:bg-primary-dark">{{ get_phrase('Login') }}</a> @endif <span class="toggle-bar
...
<div class="offcanvas offcanvas-start bg-neutral" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
    ...
    <div class="offcanvas-body px-4">
        <div class="off-menu">
            ...
            <div class="mt-3 flex-shrink-0">
                    ...
                    @auth
                        <li>
                            <div class="d-flex align-items-center my-4 mt-5">
                                ...
                                <a data-bs-toggle="tooltip" title="{{ get_phrase('Logout') }}" class="btn bg-primary text-white hover:bg-primary-light active:bg-primary-dark text-14px me-3 ms-auto" href="{{ route('logout') }}"> <i class="fi-rr-arrow-right-to-bracket"></i> </a>
                            </div>
                        </li>
                        @if (auth()->user() && auth()->user()->role == 'student')
                            @php
                                $numberof_wishlist_item = App\Models\Wishlist::where('user_id', auth()->user()->id)->count();
                            @endphp
                            <li><a href="{{ route('my.courses') }}" class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3 text-secondary hover:text-primary"> {{ get_phrase('My Courses') }}</a></li>
                            <li><a href="{{ route('wishlist') }}" class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3 text-secondary hover:text-primary"> {{ get_phrase('Wishlist') }} <span class="badge bg-pink ms-auto">{{ $numberof_wishlist_item }}</span></a></li>
                            <li><a href="{{ route('my.profile') }}" class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3 text-secondary hover:text-primary"> {{ get_phrase('My profile') }}</a></li>
                            <li><a href="{{ route('message') }}" class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3 text-secondary hover:text-primary"> {{ get_phrase('Message') }}</a></li>
                            <li><a href="{{ route('purchase.history') }}" class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3 text-secondary hover:text-primary"> {{ get_phrase('Purchase History') }}</a></li>
                        @elseif (auth()->user() && auth()->user()->role == 'admin')
                            <li><a href="{{ route('admin.dashboard') }}" class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3 text-secondary hover:text-primary"> {{ get_phrase('Admin Dashboard') }}</a></li>
                        @endif
                        <li>
                            <hr>
                        </li> @endauth

                    <li><a href="{{ route('home') }}" class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3 text-secondary hover:text-primary"> {{ get_phrase('Home') }}</a></li>
                    <li>
                        <button class="btn btn-toggle d-inline-flex align-items-center text-16px fw-500 w-100 collapsed rounded border-0 py-3 text-secondary hover:text-primary" data-bs-toggle="collapse" data-bs-target="#category-collapse" aria-expanded="false">
                            {{ get_phrase('Courses') }}
                        ...
                        <div class="collapse" id="category-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal small bg-white pb-1 pb-3 pt-0">
                                ...
                                @foreach ($parent_categories->take(30) as $parent_category)
                                    <li>
                                        <a class="w-100 px-3 py-2 text-secondary hover:text-primary" href="{{ route('courses', $parent_category->slug) }}">{{ $parent_category->title }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                    </li>
                    <li><a href="{{ route('bootcamps') }}" class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3 text-secondary hover:text-primary">{{ get_phrase('Bootcamp') }}</a></li>
                ...
                @guest
                    <div class="btn-off">
                        <a href="{{ route('login') }}" class="eBtn btn gradient mb-3 bg-primary text-white hover:bg-primary-light active:bg-primary-dark">{{ get_phrase('Login') }}</a>
                        <a href="{{ route('register.form') }}" class="eBtn btn gradient sign bg-secondary text-white hover:bg-secondary-light active:bg-secondary-dark">{{ get_phrase('Sign Up') }}</a>
                    </div>
                @endguest
            </div>
        </div>
